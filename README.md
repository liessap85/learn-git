...
**5**. *Add remote repo (name is usually origin)*
```
...
*If you want to view your config file easily, go to your HOME folder and run following (you can edit this file using nano as well if you want.)*
...
```
/c/Users/<YOUR-NAME>/.ssh/<KEY-NAME>
```
...
```
ssh-add /c/Users/<YOUR-NAME>/.ssh/<KEY-NAME>
```
...
```
cat /c/Users/<YOUR-NAME>/.ssh/<KEY-NAME>.pub
```
